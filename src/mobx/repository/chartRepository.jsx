...
class BubbleChartRepository{
    ...
    getFollowLineData(index) {
        // 기본적으로 샘플데이터(배열)를 배열로 저장해놓았으므로 1개 밖에 없다.
        if(index < this.followLineGuideData.length) {
            return this.followLineGuideData[index];
        }else {
            return null;
        }
    }
    ...
    exportMethod() {
        return {
            ...
            followLineData: this.getFollowLineData,
